...
The validator normalizes the length-delimited opaque HWCONFIG extension and
...
- a type-12 payload that contains the complete known 256-byte prefix and ends
  within the HWCONFIG partition;
...
HWCONFIG check value and opaque record extension remain unknown. The tool
...
- unknown bounded type-12 extensions were accepted and preserved, while short
  and out-of-partition record lengths were rejected;
