...
- Removed whole-image reference hashes from runtime analysis and removed their
  stable-read shortcut. Every raw dump now requires three matching physical
  reads unless reduced confidence is explicitly accepted with
  `--allow-fewer-reads`.
