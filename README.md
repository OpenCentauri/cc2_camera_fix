...
two-pass flash backup. Destructive USB restore remains hardware-unverified; read
the subproject status and protocol documents before using write operations.
